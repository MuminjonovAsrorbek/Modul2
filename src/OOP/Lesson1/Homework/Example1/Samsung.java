...
public class Samsung extends Phone{
    ...
    public Samsung(String model, String nomi, int yil, String spu, String androidVersion, String battery, boolean isPen) {
    ...
    public Samsung(String androidVersion, String battery, boolean isPen) {
        this.androidVersion = androidVersion;
        this.battery = battery;
        this.isPen = isPen;
    }
